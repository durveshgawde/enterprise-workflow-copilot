...
import { ArrowRight, Zap, Brain, Share2 } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <div className="space-x-4">
            <Link href="/signup" className="inline-block px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
              Get Started
            </Link>
            <Link href="#features" className="inline-block px-8 py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50">
              Learn More
            </Link>
          </div>
        </div>
        ...
        <div id="features" className="grid md:grid-cols-3 gap-8 py-20">
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              Convert raw text into structured workflows using GPT-4o-mini
            </p>
          </div>
